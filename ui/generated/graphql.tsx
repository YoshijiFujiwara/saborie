...
export type CreateCommentMutation = { __typename?: "Mutation" } & {
  createComment: { __typename?: "Comment" } & Pick<Comment, "id" | "body"> & {
...
export type CreatePostMutation = { __typename?: "Mutation" } & {
  createPost: { __typename?: "Post" } & Pick<
    Post,
    "id" | "todo" | "mistake" | "minutes" | "excuse"
  > & { author: { __typename?: "User" } & Pick<User, "id" | "email"> };
};
...
export type MeQuery = { __typename?: "Query" } & {
  me: { __typename?: "AuthPayload" } & Pick<AuthPayload, "id" | "email">;
};
...
export type SwitchLikeMutation = { __typename?: "Mutation" } & {
  switchLike: Maybe<
    { __typename?: "Like" } & Pick<Like, "id"> & {
        author: { __typename?: "User" } & Pick<User, "id" | "email">;
        post: { __typename?: "Post" } & Pick<Post, "id">;
...
export function useSearchPostsQuery(
  ...
  return ApolloReactHooks.useQuery<SearchPostsQuery, SearchPostsQueryVariables>(
    SearchPostsDocument,
    baseOptions
  );
}
export function useSearchPostsLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    SearchPostsQuery,
    SearchPostsQueryVariables
  >(SearchPostsDocument, baseOptions);
}
...
>;
export type SearchPostsQueryResult = ApolloReactCommon.QueryResult<
  SearchPostsQuery,
  SearchPostsQueryVariables
>;
...
`;
export type SwitchLikeMutationFn = ApolloReactCommon.MutationFunction<
  SwitchLikeMutation,
  SwitchLikeMutationVariables
>;
 ...
 * });
 */
export function useSwitchLikeMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    SwitchLikeMutation,
    SwitchLikeMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    SwitchLikeMutation,
    SwitchLikeMutationVariables
  >(SwitchLikeDocument, baseOptions);
}
export type SwitchLikeMutationHookResult = ReturnType<
  typeof useSwitchLikeMutation
>;
export type SwitchLikeMutationResult = ApolloReactCommon.MutationResult<
  SwitchLikeMutation
>;
export type SwitchLikeMutationOptions = ApolloReactCommon.BaseMutationOptions<
  SwitchLikeMutation,
  SwitchLikeMutationVariables
>;
